...
export default function PwaInstallPrompt() {
  ...
  return (
    <>
      <div className="md:hidden bg-gradient-to-r from-indigo-900/90 via-slate-900 to-amber-950/80 border-b border-indigo-500/40 p-2 px-4 flex items-center justify-between shadow-xl animate-fadeIn">
            ...
            <div className="space-y-3 text-xs text-slate-300">
              <div className="p-3 rounded-2xl bg-slate-950 border border-slate-800 space-y-2">
                ...
                <ol className="list-decimal pl-4 space-y-1 text-[11px] text-slate-400">
                  <li>하단 <strong>공유 아이콘 (<Share2 className="w-3 h-3 inline" />)</strong>을 탭합니다.</li>
                  <li><strong>'홈 화면에 추가 (<PlusSquare className="w-3 h-3 inline" />)'</strong>를 선택합니다.</li>
              ...
              <div className="p-3 rounded-2xl bg-slate-950 border border-slate-800 space-y-2">
                ...
                <ol className="list-decimal pl-4 space-y-1 text-[11px] text-slate-400">
                  <li>브라우저 메뉴 <strong>(점 3개 ⋮)</strong>를 탭합니다.</li>
